...
namespace UdemyProject2.Inputs
{
    ...
    ""maps"": [
        {
            ""name"": ""PlayerOnFoot"",
            ""id"": ""9980d3fc-cbb5-4667-8c0a-95ef74741061"",
            ""actions"": [
                {
                    ""name"": ""HorizontalMove"",
                    ""type"": ""Value"",
                    ""id"": ""34e49139-a8b2-4c3c-a717-bf6ea3e8752a"",
                ...
                },
                {
                    ""name"": ""Jump"",
                    ""type"": ""PassThrough"",
                    ""id"": ""98215f02-9215-4f21-aece-009aaeae3092"",
            ...
            ""bindings"": [
                {
                    ""name"": ""AD"",
                    ""id"": ""5a50ecaa-aa2f-47f8-9457-0949cf994f1e"",
                    ""path"": ""1DAxis"",
                    ""interactions"": ""Press(behavior=2)"",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": ""negative"",
                    ""id"": ""b0b71f04-c99e-472d-917f-ab6b35592f90"",
                    ""path"": ""<Keyboard>/a"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": ""positive"",
                    ""id"": ""d17ee055-8092-4777-9cff-3ed587b776f7"",
                    ""path"": ""<Keyboard>/d"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": ""GamePad"",
                    ""id"": ""acf7075f-2932-489c-8396-861783a4d8ed"",
                    ""path"": ""1DAxis"",
                    ""interactions"": """",
                ...
                {
                    ""name"": ""Negative"",
                    ""id"": ""70316b97-c92e-4a10-83b9-bf2c45519f26"",
                ...
                {
                    ""name"": ""Positive"",
                    ""id"": ""bc1e86c1-6401-4fde-abd8-7852bb582f1d"",
                ...
                {
                    ""name"": """",
                    ""id"": ""91eeaec2-8d5a-4c20-a24c-2a0eb6671b21"",
                    ""path"": ""<Keyboard>/space"",
                ...
                {
                    ""name"": """",
                    ""id"": ""a415f5e4-d1d7-4664-9377-35fdadd660cd"",
